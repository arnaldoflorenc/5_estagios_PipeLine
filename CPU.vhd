...
SIGNAL CLK: STD_LOGIC;
	...
	-- BUFFERS 
	BUFFERD : BUFFERS PORT MAP (DATAIN, EXTERN, BUSS);
	BUFFER1 : BUFFERS PORT MAP (REG1,   R1OUT,  BUSS);
	BUFFER2 : BUFFERS PORT MAP (REG2,   R2OUT,  BUSS);
	BUFFER3 : BUFFERS PORT MAP (REG3,   R3OUT,  BUSS);
	BUFFERG : BUFFERS PORT MAP (RESULT,  GOUT,  BUSS);
	BUFFERA : BUFFERS PORT MAP (REGA,     AOUT, BUSS);
